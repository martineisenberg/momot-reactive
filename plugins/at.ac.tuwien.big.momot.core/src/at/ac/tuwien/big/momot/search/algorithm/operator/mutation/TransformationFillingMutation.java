...
public class TransformationFillingMutation extends AbstractTransformationMutation {
   private final SearchHelper searchHelper;

   public TransformationFillingMutation(final SearchHelper searchHelper) {
      this.searchHelper = searchHelper;
   }

   public TransformationFillingMutation(final SearchHelper searchHelper, final double probability) {
      super(probability);
      this.searchHelper = searchHelper;
   }
